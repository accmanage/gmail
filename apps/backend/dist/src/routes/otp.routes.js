...
otpRouter.post("/generate", otpLimiter, validate(z.object({ body: z.object({ accessId: z.number().int() }) })), asyncHandler(async (req, res) => {
    ...
    if (!assignment)
        throw new AppError(404, "Assigned account not found or expired");
...
otpRouter.get("/history", asyncHandler(async (req, res) => {
